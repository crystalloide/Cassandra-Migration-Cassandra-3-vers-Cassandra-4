...
## Option 1 : Pour lancer notre TP : sur un environnement prêt mais sans cassandra 3.x préinstallé  :
...
## Option 2 : Pour lancer notre TP : sur un environnement prêt avec un cassanda 3.x en service  :
